...
void CharacterBooster::BoostPlayerWithGear(Player *player, uint32 targetLevel, uint8 specialization, uint32 copperAmount)
{
    UpdatePlayerLevel(player, targetLevel);
    UpdateProficiencies(player, specialization);
    EquipNewItems(player, specialization, targetLevel);
    GiveCopper(player, copperAmount);
}

void CharacterBooster::UpdatePlayerLevel(Player *player, uint32 targetLevel)
{
...
void CharacterBooster::UpdateProficiencies(Player *player, uint8 specialization)
{
...
void CharacterBooster::EquipNewItems(Player *player, uint8 specialization, uint32 targetLevel)
{
    std::vector<std::vector<int>> itemList = GetItemList(player->getClass(), specialization, targetLevel);
...
void CharacterBooster::GiveCopper(Player *player, uint32 copperAmount)
{
    if (copperAmount <= 0)
        return;
...
std::vector<std::vector<int>> CharacterBooster::GetItemList(uint32 classId, uint8 specialization, uint32 targetLevel)
{
